...
class TestValueIterationsGMP(unittest.TestCase):
    ...
    #         val, msg="Check that value_of returns a value (TASK 2.1)")
    ...
    #     self.assertIsNotNone(
    #         v, msg="Check if value_iteration returns a value (TASK 2.2)")
    #     # It needs to return a dictionary.
    #     self.assertIsInstance(
    #         v, dict, msg="value_iteration needs to return a dictionary (TASK 2.2)")
    ...
    def test_3_GridMDP_1(self):
        ...
        v = value_iteration(gdp, gamma, epsilon)
        self.assertIsNotNone(
            v, msg="Check if value_iteration returns a value.")
        # It needs to return a dictionary.
        self.assertIsInstance(
            v, dict, msg="value_iteration needs to return a dictionary")
        # Correct values
